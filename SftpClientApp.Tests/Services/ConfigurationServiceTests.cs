...
namespace SftpClientApp.Tests.Services
{
    public class ConfigurationServiceTests
    {
        ...
        public async Task GetSftpConfigurations_ReturnsConfigurations()
        {
            ...
            var configService = new ConfigurationService(dbContext);
            dbContext.SftpConfigurations.Add(new SftpConfiguration { Id = 1, Host = "example.com", Username = "alex", Password = "1234" });
            dbContext.SftpConfigurations.Add(new SftpConfiguration { Id = 2, Host = "example2.com", Username = "thisaa", Password = "1i239821923ui!!22k2i8_123" });
